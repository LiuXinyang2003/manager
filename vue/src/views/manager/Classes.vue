<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入班级名称" style="width: 200px" v-model="params.name"></el-input>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="teacherId" label="所属专业">
          <el-select v-model="form.specialityId" placeholder="请选择学院" style="width: 100%">
            <el-option v-for="item in specialityData" :label="item.name" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="studentId" label="班主任">
...
<script>
import speciality from "@/views/manager/Speciality.vue";
