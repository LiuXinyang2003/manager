...
public class ClassesController {
    ...
    public Result updateClassTotal(@RequestBody Classes classes) {
        classesService.updateClassTotal(classes);
        return Result.success();
    }
    ...
    public Result selectPage(Params params) {
        PageInfo<Classes> page = classesService.selectPage(params);
